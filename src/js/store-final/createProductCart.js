const createProductCard = ({ id, photo, model, prices }) => {
  ...
  li.innerHTML = `
    <article class="product-final js-link-card" id="${id}">
      <a href="#" class="product__image">
        <div class="product__switch image-switch">
          ...
          <div class="image-switch__item">
            <div class="image-switch__image"><img class="image-switch__img js-image-card" src="${photo[3]}"
                alt="photo product"></div>
          </div>
        </div>
      ...
      <div class="product__price product-price ">
        <div class="product-price__current js-price-card">${prices[1]} $</div>
        <div class="product-price__old js-price-card-old">${prices[0]} $</div>
      </div>
